...
if ('IntersectionObserver' in window) {
    /* Logic for TIER 2 table-of-contents */
    document.addEventListener('DOMContentLoaded', function () {
        const links = document.querySelectorAll('#left-sidebar ul > li > ul > li > a');
        let activeLink = null;
        const linksById = {};
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const links = document.querySelectorAll('#left-sidebar ul > li > ul > li > ul > li > a');
        let activeLink = null;
        const linksById = {};
